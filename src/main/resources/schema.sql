...
-- Таблица
CREATE TABLE electronics_type_employee (
...
INSERT INTO purchases (electronics_id, employee_id, store_id, purchase_datetime, purchase_type_id) VALUES
         ...
         (2, 2, 2, '2023-01-11 11:20:00', 2),
         (3, 3, 3, '2023-01-12 12:25:00', 3),
         (4, 4, 4, '2023-01-13 13:30:00', 4),
         (5, 5, 5, '2023-01-14 14:35:00', 5),
         (6, 6, 6, '2023-01-15 15:40:00', 6),
         (7, 7, 7, '2023-01-16 16:45:00', 7),
         (8, 8, 8, '2023-01-17 17:50:00', 8),
         (9, 9, 9, '2023-01-18 18:55:00', 9),
         (10, 10, 10, '2023-01-19 19:00:00', 10);
